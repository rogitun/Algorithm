package Algo_2022.SwExpert.hash.Sw9465;
        ...
        for (int i = 1; i < Q; ++i) {
            ...
            switch (cmd) {
                ...
                case GETCOUNT:
                    ...
                    System.out.println("Count/ my : " + ret + " | answ = " + param2);
                ...
                case DELETEMAIL:
                    if (sample == 1) {
                        ...
                        System.out.println("del/ my : " + ret + " | answ : " + param2);
                        if (ret != param2) answer = 0;
                    }
                    else {
                        param1 = Integer.parseInt(st.nextToken());
                ...
                case SEARCHMAIL:
                    ...
                    System.out.println("search/ my : " + ret + " | ans : " +param2);
                    if (ret != param2) answer = 0;
                    break;
                default:
                    break;
