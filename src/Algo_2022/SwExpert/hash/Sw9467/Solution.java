package Algo_2022.SwExpert.hash.Sw9467;
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int TC = 1; TC <= T; TC++) {
            ...
            for (int i = 0; i < query_cnt; i++)
            {
                ...
                int ans = sc.nextInt();
                System.out.println("ans + " + ans + " " + "my : " + user_ans);
                if (ans != user_ans)
                {
                    score = 0;
                }
            ...
            System.out.println(String.valueOf(result_string) + " | " + String.valueOf(user_ans_string));
            for (int i = 0; i < init_string_len; i++)
            {
